            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg flex justify-between items-center overflow-x-auto">
                ...
                @if(!$jornadaObj->cerrada && $jornada == $jornada_actual)
                    <div class="flex justify-between items-center">
                            <div class="widget p-4 rounded-lg bg-white border border-gray-100 dark:bg-gray-900 dark:border-gray-800">
